...
# 加载环境变量
load_dotenv()
OPENAI_API_KEY = "sk-0DqtNbkbXEHDDCX083A5C003E7584d5f819e44907b3e61B9" # 从 .env 文件中读取 API 密钥
BASE_URL = os.getenv("OPENAI_BASE_URL", "https://api.xty.app/v1")  # 默认值可根据需要调整
...
def main():
    ...
    """
    # 配置路径
    input_jsonl = "/home/user1/zjs/Medqa/1.jsonl"  # 请替换为实际路径
