...
# 加载环境变量
load_dotenv()
OPENAI_API_KEY = "sk-0DqtNbkbXEHDDCX083A5C003E7584d5f819e44907b3e61B9"  # 请确保安全存储
...
def main():
    ...
    """
    # 配置路径
    input_jsonl = "/home/user1/zjs/Pubmedqa/1.jsonl" # 请替换为实际路径
    filtered_definitions_root = "filtered_results"  # 假设之前的筛选结果保存在此目录
    output_root_dir = "gpt_generated_results_simple"
