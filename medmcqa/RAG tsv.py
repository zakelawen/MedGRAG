...
# 定义路径
jsonl_file = '/home/user1/zjs/实验/最终测试数据进行RAG实验/medmcqa.jsonl'  # 替换为您的 JSONL 文件路径
output_tsv = 'output.tsv'  # 输出 TSV 文件名

# 文件路径模板
base_dir = '/home/user1/zjs/实验/实验最终代码/medmcqa/filtered_results'
base_dir4 = '/home/user1/zjs/实验/实验最终代码/medmcqa/gpt_generated_results'
